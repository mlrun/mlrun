...
class Member(project_leader.Member):
    ...
    def create_project(
        ...
        ) = server.py.services.api.utils.singletons.project_member.get_project_member().create_project(
    ...
    def delete_project(
        ...
        return server.py.services.api.utils.singletons.project_member.get_project_member().delete_project(
    ...
    def get_project(
        ...
        return server.py.services.api.utils.singletons.project_member.get_project_member().get_project(

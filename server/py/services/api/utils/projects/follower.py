...
class Member(
    ...
    def initialize(self):
        ...
        self._leader_client: services.api.utils.projects.remotes.leader.Member
        if self._leader_name == "iguazio":
            self._leader_client = services.api.utils.clients.iguazio.Client()
    ...
    def store_project(
        ...
        if services.api.utils.helpers.is_request_from_leader(
            ...
            try:
                ...
                return services.api.db.session.run_function_with_new_db_session(
    ...
    async def get_project_summary(
        ...
        return await services.api.crud.Projects().get_project_summary(db_session, name)

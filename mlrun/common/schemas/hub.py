...
# ``mlrun.common.schemas.hub`` import path. Mirrors the full namespace of the underlying
...
from ._shared import hub as _shared_mod

if _USE_V2:
    from ._v2 import hub as _face_mod
else:
    from ._v1 import hub as _face_mod

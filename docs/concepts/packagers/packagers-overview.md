...
See [Setting a project source, either remote or archive](../../projects/automate-project-git-source.ipynb#setting-a-project-source-either-remote-or-archive). The git repo or archive file in S3 needs to contain the custom packager files.

...
class MlrunProject(ModelObj):
    ...
    def get_drift_over_time(
        ...
        For a range of 6 hours or less, the granularity is 10 minute, for a range of 2 hours to 72 hours, the granularity is 1 hour,
        and for a range of more than 72 hours, the granularity is 24 hours.

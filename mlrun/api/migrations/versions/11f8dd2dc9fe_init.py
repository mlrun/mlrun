...
def upgrade():
    ...
    op.create_table(
        "schedules_v2",
        sa.Column("project", sa.String(255, collation=SQLCollationUtil.collation()), nullable=False),
        sa.Column("name", sa.String(255, collation=SQLCollationUtil.collation()), nullable=False),
        sa.Column("kind", sa.String(255, collation=SQLCollationUtil.collation()), nullable=True),
        ...
        sa.Column(
            "cron_trigger_str", sa.String(255, collation=SQLCollationUtil.collation()), nullable=True
        ),

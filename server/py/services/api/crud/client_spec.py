...
class ClientSpec(
    ...
    def get_client_spec(
        ...
        mpijob_crd_version = (
            server.py.services.api.runtime_handlers.mpijob.resolve_mpijob_crd_version()
        )
        return mlrun.common.schemas.ClientSpec(
            ...
            nuclio_version=server.py.services.api.utils.runtimes.nuclio.resolve_nuclio_version(),

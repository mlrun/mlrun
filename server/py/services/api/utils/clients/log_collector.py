...
import server.py.services.api.utils.clients.protocols.grpc
...
class LogCollectorClient(
    server.py.services.api.utils.clients.protocols.grpc.BaseGRPCClient,
    ...
    def _initialize_proto_client_imports(self):
        ...
        import server.py.proto.log_collector_v1_pb2

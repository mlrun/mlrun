...
from server.py.services.api.runtime_handlers.kubejob import KubeRuntimeHandler
...
"""
    ...
    def _submit_spark_job(
        ...
        k8s = server.py.services.api.utils.singletons.k8s.get_k8s_helper()
    ...
    def _delete_extra_resources(
        ...
        config_maps = server.py.services.api.utils.singletons.k8s.get_k8s_helper().v1api.list_namespaced_config_map(
        ...
        for config_map in config_maps.items:
            try:
                ...
                if force or uid in uids:
                    server.py.services.api.utils.singletons.k8s.get_k8s_helper().v1api.delete_namespaced_config_map(

...
def _apply_mlrun_on_module(
    ...
    sample_set: LGBMTypes.DatasetType | mlrun.DataItem | str = None,
    ...
    extra_data: dict[str, LGBMTypes.ExtraDataType] | None = None,
    auto_log: bool = True,
    mlrun_logging_callback_kwargs: dict[str, Any] | None = None,
):

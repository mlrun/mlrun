...
import server.api.utils.projects.remotes.nop_follower
...
class Member(
    ...
    def _initialize_follower(
        ...
        followers_classes_map = {
            ...
            # for tests
            "nop-self-leader": server.api.utils.projects.remotes.nop_follower.Member(),
            "nop": server.api.utils.projects.remotes.nop_follower.Member(),
            "nop2": server.api.utils.projects.remotes.nop_follower.Member(),
        }

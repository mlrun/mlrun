...
repos = [
    ...
    {"url": "https://github.com/mlrun/demo-monitoring-and-feedback-loop.git", "name": "demo-monitoring-and-feedback-loop"},
    {"url": "https://github.com/mlrun/demo-call-center.git", "name": "demo-call-center"},

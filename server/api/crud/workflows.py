...
class BaseRunner(metaclass=mlrun.utils.singleton.Singleton):
    ...
    def prepare_and_run(
        ...
        labels: dict[str, str],
        workflow_request: typing.Optional[mlrun.common.schemas.WorkflowRequest] = None,
        ...
        server.api.api.utils.mask_notification_params_on_task_object(
            run_object, server.api.constants.MaskOperations.CONCEAL
        )
    ...
    def _create_run_object(
        ...
        handler: str,
        parameters: dict,
        notifications: typing.Optional[list[mlrun_model.Notification]] = None,
        run_name: str = None,
...
class LoadRunner(BaseRunner, metaclass=mlrun.utils.singleton.Singleton):
    ...
    def _prepare_run_object(
        ...
        run_object = self._create_run_object(
            ...
            save=save,
            handler="mlrun.projects.load_project_runner",

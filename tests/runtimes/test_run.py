...
def test_new_function_from_runtime():
    ...
    expected_runtime["spec"]["preemption_mode"] = mlrun.mlconf.function_defaults.preemption_mode
    assert (
        DeepDiff(
            function.to_dict(),
            expected_runtime,
...
def test_new_function_args_with_default_image_pull_secret():
    ...
    function = mlrun.new_function(runtime=runtime)
    expected_runtime = runtime
    expected_runtime["spec"]["image_pull_secret"] = mlrun.mlconf.function.spec.image_pull_secret.default
    expected_runtime["spec"]["preemption_mode"] = mlrun.mlconf.function_defaults.preemption_mode
    assert (
        DeepDiff(
            function.to_dict(),

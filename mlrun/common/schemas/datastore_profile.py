...
# ``mlrun.common.schemas.datastore_profile`` import path. Mirrors the full namespace of the underlying
...
if _USE_V2:
    from ._v2 import datastore_profile as _face_mod
else:
    from ._v1 import datastore_profile as _face_mod

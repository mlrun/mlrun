...
# ``mlrun.common.schemas.common`` import path. Mirrors the full namespace of the underlying
...
if _USE_V2:
    from ._v2 import common as _face_mod
else:
    from ._v1 import common as _face_mod

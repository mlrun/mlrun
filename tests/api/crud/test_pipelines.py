    ...
    cases = [
        {
            ...
            'template': {'container': {'command': ['python', '-m', 'mlrun', 'deploy', '-p', 'project-from-deploy-p']}}
        },
        {
            'expected_project': 'project-from-deploy--project',
            'template': {'container': {'command': ['python', '-m', 'mlrun', 'deploy', '--project', 'project-from-deploy--project']}}
        },
        {
            'expected_project': 'project-from-deploy-f',
            'template': {
                'container': {'command': ['python', '-m', 'mlrun', 'deploy', '-f', 'db://project-from-deploy-f/tf2-serving@2db2ec7d89c0c8c9d1b9a86279d8440ebc230597']}}
        },
        {
            'expected_project': 'project-from-deploy--func-url',
            'template': {
                'container': {'command': ['python', '-m', 'mlrun', 'deploy', '--func-url',
        ...
        },
        {
            ...
            'template': {
                'container': {'command': ['python', '-m', 'mlrun', 'run', '--func-url',
                                          'db://project-from-deploy--func-url/tf2-serving@2db2ec7d89c0c8c9d1b9a86279d8440ebc230597',
                                          '--project', 'project-from-run-precedence--project']}}
        },
        {
            'expected_project': 'project-from-build-r',
            'template': {
                'container': {'command': ['python', '-m', 'mlrun', 'build', '-r',
                                          "{'kind': 'job', 'metadata': {'project': 'project-from-build-r'}}"]}}
        },
        {
            'expected_project': 'project-from-build--runtime',
            'template': {
                'container': {'command': ['python', '-m', 'mlrun', 'build', '--runtime',
        ...
        },
        {
            ...
            'template': {
                'container': {'command': ['python', '-m', 'mlrun', 'build', '--runtime',
                                          "{'kind': 'job', 'metadata': {'project': 'project-from-build--runtime'}}", '--project', 'project-from-build-precedence--runtime']}}
        },
        {

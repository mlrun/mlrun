...
class DefaultPackager(Packager, metaclass=_DefaultPackagerMeta):
    ...
    * **The abstract class method** :py:meth:`pack`: This method is implemented to get the object and send it to the
      ...
      for unpacking it, or in the case of result, the dictionary of the result with its key and value. Returning
      an artifact means that you can return any of the common subclasses of Artifact, including:

...
# ``mlrun.common.schemas.project`` import path. Mirrors the full namespace of the underlying
...
from ._shared import project as _shared_mod

if _USE_V2:
    from ._v2 import project as _face_mod
else:
    from ._v1 import project as _face_mod

...
class EventsFactory:
    ...
    def get_events_client(
    ...
    ) -> server.py.services.api.utils.events.base.BaseEventClient:
        if mlrun.mlconf.events.mode == mlrun.common.schemas.EventsModes.disabled:
            return server.py.services.api.utils.events.nop.NopClient()
        ...
        if kind == mlrun.common.schemas.EventClientKinds.iguazio:
            ...
            return server.py.services.api.utils.events.iguazio.Client(**kwargs)

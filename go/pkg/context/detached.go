...
// NewDetachedWithCancel returns a context that is not affected by its parent, along with a cancel func.
func NewDetachedWithCancel(ctx context.Context) (context.Context, context.CancelFunc) {
	return context.WithCancel(NewDetached(ctx))
}

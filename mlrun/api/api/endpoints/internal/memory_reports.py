...
def get_most_common_objects_report():
    report = mlrun.api.utils.memory_reports.MemoryUsageReport().create_most_common_objects_report()
...
def get_memory_usage_report(
    ...
    report = mlrun.api.utils.memory_reports.MemoryUsageReport().create_memory_usage_report(

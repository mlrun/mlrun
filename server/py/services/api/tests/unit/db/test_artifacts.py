...
class TestArtifacts(TestDatabaseBase):
    ...
    def test_list_artifacts_with_model_endpoints(self):
        project = "my-project"
        artifact_name1 = "artifact_name1"
        artifact_name2 = "artifact_name2"
        artifact_name3 = "artifact_name3"
        tree1 = "artifact_tree_1"
        tree2 = "artifact_tree_2"

        artifact_1 = self._generate_artifact(
            artifact_name1, project=project, tree=tree1
        )
        artifact_2 = self._generate_artifact(
            artifact_name1, project=project, tree=tree2
        )
        artifact_3 = self._generate_artifact(artifact_name2, project=project)
        artifact_4 = self._generate_artifact(artifact_name3, project=project)
        uid1 = self._db.store_artifact(
            self._db_session,
            artifact_name1,
            artifact_1,

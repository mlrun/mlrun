...
class MlrunProject(ModelObj):
    ...
    def list_completed_runs(
        ...
        **kwargs,
        ...
        """Retrieve a list of completed runs for the project.

        The default returns runs from the last week, partitioned by name. To override the default, specify any filter.

        The returned result is a `RunList` (list of dict), use `.to_objects()` to convert it to a list of RunObjects,
        ...
        :param uid: Unique ID of the run (string or list of strings).

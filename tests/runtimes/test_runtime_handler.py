...
def test_list_kubejob_resources(k8s_helper_mock):
    ...
    k8s_helper_mock.list_pods.assert_called_once_with(k8s_helper_mock.resolve_namespace(),
...
def _assert_resources(resources, expected_crds=None, expected_pods=None, expected_services=None):
...
def _mock_kubejob_pods():
    ...
    pod = unittest.mock.Mock()
    pod.to_dict.return_value = pod_dict
    return [pod]


def _mock_daskjob_pods():
    scheduler_pod_dict = {
        'metadata': {
            ...
            'container_statuses': [
                {
                    ...
                    'image_id': 'docker-pullable://mlrun/ml-models@sha256:07cc9e991dc603dbe100f4eae93d20f3ce53af1e6d4af5191dbc66e6dfbce85b',
                    'last_state': {
                        'running': None,
                        'terminated': None,
                        'waiting': None
                    ...
                    'state': {
                        'running': {
                            'started_at': '2020-08-18T00:36:19+00:00'
                        },
                        'terminated': None,
                        'waiting': None
                    }
            ...
            'container_statuses': [
                {
                    ...
                    'state': {
                        'running': {
                            'started_at': '2020-08-18T00:36:23+00:00'
                        },
                        'terminated': None,
                        'waiting': None
                    }
    ...
    scheduler_pod = unittest.mock.Mock()
    scheduler_pod.to_dict.return_value = scheduler_pod_dict
    worker_pod = unittest.mock.Mock()
    worker_pod.to_dict.return_value = worker_pod_dict
    return [scheduler_pod, worker_pod]

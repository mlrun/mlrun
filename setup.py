...
extras_require = {
    ...
    "tensorflow": ["tensorflow==2.4.1", "bokeh~=2.3", "tf2onnx~=1.9", "onnxoptimizer~=0.2"],
    "pytorch": ["torch~=1.8", "bokeh~=2.3", "onnxoptimizer~=0.2"],
    # "sklearn": ["scikit-learn~=0.23.0", "skl2onnx~=1.9", "onnxoptimizer~=0.2"],  TODO: Alex should implement it next.
    # "xgboost": ["xgboost~=1.1", "onnxmltools~=1.9", "onnxoptimizer~=0.2"],  TODO: Alex should implement it next.
    "onnx": ["onnxruntime~=1.8.1", "onnxoptimizer~=0.2"],
    "bokeh": ["bokeh~=2.3"],
}

...
# ``mlrun.common.schemas.function`` import path. Mirrors the full namespace of the underlying
...
from ._shared import function as _shared_mod

if _USE_V2:
    from ._v2 import function as _face_mod
else:
    from ._v1 import function as _face_mod

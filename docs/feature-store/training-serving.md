...
You can serve your models using the [model server](../serving/serving-graph.html). (See an [V2 Model Server (SKLearn) example](https://github.com/mlrun/functions/blob/master/v2_model_server/v2_model_server.ipynb).)

...
class ApiStatus:
    ...
    """
    openapi_types = {"error": "str", "code": "int", "details": "list[ProtobufAny]"}

    attribute_map = {"error": "error", "code": "code", "details": "details"}

    def __init__(
        self, error=None, code=None, details=None, local_vars_configuration=None
    ):  # noqa: E501

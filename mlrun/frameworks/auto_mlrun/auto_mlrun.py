...
from .._common import ModelHandler, Types


def get_framework_by_instance(model: Types.ModelType) -> str:
    """
...
def get_framework_by_class_name(model: Types.ModelType) -> str:
    """
...
class AutoMLRun:
    ...
    @staticmethod
    def _get_framework(
        model: Types.ModelType = None, model_path: str = None

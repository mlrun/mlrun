...
For example, running `MLRUN_VERSION=1.1.1 make docker-images` will generate the following images:
  * `mlrun/mlrun-api:1.1.1`
  * `mlrun/mlrun:1.1.1`
  * `mlrun/jupyter:1.1.1`
  * `mlrun/ml-base:1.1.1`
  * `mlrun/ml-models:1.1.1`
  * `mlrun/ml-models-gpu:1.1.1` 

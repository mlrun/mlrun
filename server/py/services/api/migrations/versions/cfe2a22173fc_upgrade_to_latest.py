...
def upgrade():
    ...
    op.drop_index("_feature_vectors_tags_obj_name_fk", table_name="feature_vectors_tags")
...
def downgrade():
    ...
    op.create_index("_functions_tags_obj_name_fk", "functions_tags", ["obj_name"], unique=False)
    op.create_index(

...
func StartServer() error {
	...
	bytesReadPerLogTimeUpdate := flag.Int("bytes-read-per-log-time-update", common.GetEnvOrDefaultInt("MLRUN_LOG_COLLECTOR__BYTES_READ_PER_LOG_TIME_UPDATE", common.BytesReadPerLogTimeUpdate), "Amount of logs to read between updates of the last log time in the 'in memory' state, in bytes (default: 4KB)")

...
class PipelineUploadServiceApi:
    ...
    def upload_pipeline_with_http_info(self, uploadfile, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            "uploadfile" not in local_var_params  # noqa: E501
            or local_var_params["uploadfile"] is None
        ):  # noqa: E501
            raise ApiValueError(
        ...
        if (
            "description" in local_var_params
            and local_var_params["description"] is not None
        ):  # noqa: E501
    ...
    def upload_pipeline_version_with_http_info(self, uploadfile, **kwargs):  # noqa: E501
        ...
        >>> thread = api.upload_pipeline_version_with_http_info(
        ...     uploadfile, async_req=True
        ... )
        >>> result = thread.get()
        ...
        all_params = ["uploadfile", "name", "pipelineid", "description"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        if "name" in local_var_params and local_var_params["name"] is not None:  # noqa: E501
            query_params.append(("name", local_var_params["name"]))  # noqa: E501
        if (
            "pipelineid" in local_var_params
            and local_var_params["pipelineid"] is not None
        ):  # noqa: E501

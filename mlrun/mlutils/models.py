...
def eval_class_model(
    ...
    # CONFUSION MATRIX
    gcf_clear(plt)
    cmd = metrics.plot_confusion_matrix(model, xtest, ytest, normalize='all', cmap=plt.cm.Blues)
    ...
    if is_multiclass:
        ...
        model_metrics["plots"].append(PlotArtifact("precision-recall-multiclass", body=plt.gcf()))

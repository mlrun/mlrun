...
class TestModelEndpointsOperations(TestMLRunSystemModelMonitoring):
    ...
    def test_creation_strategy(self, creation_strategy):
        ...
        if creation_strategy == mm_constants.ModelEndpointCreationStrategy.INPLACE:
            ...
            assert db_model_endpoint.spec.function_name == created_model_endpoint.spec.function_name
            assert db_model_endpoint.spec.monitoring_feature_set_uri == created_model_endpoint.spec.monitoring_feature_set_uri
            assert db_model_endpoint.spec.label_names == created_model_endpoint.spec.label_names

...
def test_marketplace(create_server):
    ...
    new_source.order = 1
    _assert_source_lists_match(db, [new_source, default_source])
    ...
    new_source.order = 2
    _assert_source_lists_match(db, [new_source_2, new_source, default_source])

    new_source.order = 1
    db.store_marketplace_source(new_source.source.metadata.name, new_source)
    new_source_2.order = 2
    _assert_source_lists_match(db, [new_source, new_source_2, default_source])

    db.delete_marketplace_source("source-1")
    new_source_2.order = 1
    _assert_source_lists_match(db, [new_source_2, default_source])
...
class LocalFeatureMerger:
    ...
    def start(
        ...
        if not drop_indexes and index_columns:
            ...
            if self._result_df.index is None or isinstance(self._result_df.index, pd.core.indexes.range.RangeIndex):
                ...
                if not index_columns_missing:
                    ...
                    logger.warn(f"Can't set index, not all index columns found: {index_columns_missing}. "

...
def build_image(
    ...
    source_target_dir = (
        runtime.spec.build.source_target_dir or runtime.spec.clone_target_dir
    )
    if source_to_copy and (
        not source_target_dir or not os.path.isabs(source_target_dir)
    ):
        relative_workdir = source_target_dir or ""
        relative_workdir = relative_workdir.removeprefix("./")

        runtime.spec.build.source_target_dir = path.join(
    ...
    dock = make_dockerfile(
        ...
        target_dir=runtime.spec.build.source_target_dir,

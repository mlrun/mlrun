...
async def store_project_secrets(
    ...
    await run_in_threadpool(
        server.py.services.api.utils.singletons.project_member.get_project_member().get_project,
        db_session,
        project,
        auth_info.session,
    )
    ...
    await run_in_threadpool(
        server.py.services.api.crud.Secrets().store_project_secrets, project, secrets
    )
...
async def list_project_secret_keys(
    ...
    return await run_in_threadpool(
        server.py.services.api.crud.Secrets().list_project_secret_keys,
        project,
        provider,
        token,
    )

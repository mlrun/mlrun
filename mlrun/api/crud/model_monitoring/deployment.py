...
class MonitoringDeployment:
    def deploy_monitoring_functions(
        ...
        """
        max_parquet_save_interval = self.deploy_model_monitoring_stream_processing(
            project=project,
        ...
        self.deploy_model_monitoring_batch_processing(
            ...
            auth_info=auth_info,
            tracking_policy=tracking_policy,
            tracking_offset=max_parquet_save_interval,
        )
    ...
    def deploy_model_monitoring_stream_processing(
        ...
        :return:                            Max interval in seconds of parquet saving
        """
        ...
        (
            fn,
            max_parquet_save_interval,
        ) = self._initial_model_monitoring_stream_processing_function(
            project=project,
            model_monitoring_access_key=model_monitoring_access_key,
            tracking_policy=tracking_policy,
            auth_info=auth_info,
        ...
        return max_parquet_save_interval
    ...
    def _initial_model_monitoring_stream_processing_function(
        ...
        auth_info: mlrun.common.schemas.AuthInfo,
        parquet_target: str,
    ) -> typing.Tuple[typing.Any, Seconds]:
        """
        ...
        :return:                            A tuple of:
                                            function object from a mlrun runtime class,
                                            max interval in seconds of parquet saving
        ...
        return function, stream_processor.parquet_batching_timeout_secs

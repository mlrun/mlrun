...
# ``mlrun.common.schemas.notification`` import path. Mirrors the full namespace of the underlying
...
from ._shared import notification as _shared_mod

if _USE_V2:
    from ._v2 import notification as _face_mod
else:
    from ._v1 import notification as _face_mod

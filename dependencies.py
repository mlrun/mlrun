...
def extra_requirements() -> dict[str, list[str]]:
    ...
    extras_require = {
        ...
        "dask": [
            ...
            'dask~=2024.8.0; python_version >= "3.11"',
            'distributed~=2023.12.1; python_version < "3.11"',
            'distributed~=2024.8.0; python_version >= "3.11"',
        ],
    ...
    extras_require.update(
        {
            "kfp18": ["mlrun_pipelines_kfp_v1_8[kfp]>=0.4.0; python_version < '3.11'"],
            # TODO uncomment when KFP 1.8 support is removed
            # "kfp2": ["mlrun_pipelines_kfp_v2[kfp]>=0.4.2 ; python_version >= '3.11'"],
            "api": api_deps,

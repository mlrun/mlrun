...
async def store_project_secrets(
    ...
    await run_in_threadpool(
        server.api.crud.Secrets().store_project_secrets, project, secrets
    )
...
async def delete_project_secrets(
    ...
    await run_in_threadpool(
        server.api.crud.Secrets().delete_project_secrets, project, provider, secrets
    )
...
async def list_project_secret_keys(
    ...
    return await run_in_threadpool(
        server.api.crud.Secrets().list_project_secret_keys, project, provider, token
    )

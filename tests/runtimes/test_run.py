    ...
    for test_case in [
        {
            ...
            "default_resources": {
                "requests": {"cpu": "25mi", "memory": "1M", "gpu": None, 'ephemeral_storage':None},
        ...
        },
        {
            "resources": {"requests": {"cpu": "50mi"}},
            "default_resources": {
                "requests": {"cpu": "25mi", "memory": "1M", "gpu": "1", 'ephemeral_storage':None},
                "limits": {"cpu": "1", "memory": "1G", "gpu": "1", 'ephemeral_storage':None},
            },
            "expected_resources": {
                "requests": {"cpu": "50mi", "memory": "1M"},
                "limits": {"cpu": "1", "memory": "1G"},

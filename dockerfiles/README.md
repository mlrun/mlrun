...
For example, running `MLRUN_VERSION=1.3.4 make docker-images` will generate the following images:
  * `mlrun/mlrun-api:1.3.4`
  * `mlrun/mlrun:1.3.4`
  * `mlrun/jupyter:1.3.4`
  * `mlrun/ml-base:1.3.4`
  * `mlrun/ml-models:1.3.4`
  * `mlrun/ml-models-gpu:1.3.4` 

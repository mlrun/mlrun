...
class TestFeatureStore(TestMLRunSystem):
    ...
    #
    #     print("xxxxxxxxx " + str(self.project_name))
    #
    #     feature_set = fs.FeatureSet(name="blabla3", entities=[fs.Entity("patient_id")], timestamp_key='timestamp', )
    ...
    #     )
    #
    #     fs.ingest(feature_set, source, targets=[target], run_config=fs.RunConfig(local=False).apply(mlrun.platforms.auto_mount()))

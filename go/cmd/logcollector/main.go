...
func StartServer() error {
	...
	bufferSizeBytes := flag.Int("buffer-size-bytes", common.GetEnvOrDefaultInt("MLRUN_LOG_COLLECTOR_BUFFER_SIZE_BYTES", 10*1024*1024), "Size of buffer in bytes for reading pod logs (default: 10MB)")

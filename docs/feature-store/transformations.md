...
* [**Aggregations**](#aggregations) - MLRun supports adding aggregate features to a feature set through the 
  {py:func}`~mlrun.feature_store.FeatureSet.add_feature_aggregation` function.
...
For a full documentation of this function, please visit the {py:func}`~mlrun.feature_store.FeatureSet.add_feature_aggregation` 
documentation.

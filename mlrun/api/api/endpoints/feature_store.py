...
def create_feature_set(
    ...
    feature_set_uid = get_db().create_feature_set(
        db_session, project, feature_set, versioned, auth_info.session
    )
...
def ingest_feature_set(
    ...
    feature_set._override_run_db(db_session, auth_info.session)
...
def create_feature_vector(
    ...
    feature_vector_uid = get_db().create_feature_vector(
        db_session, project, feature_vector, versioned, auth_info.session
    )

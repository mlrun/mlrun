...
- `bucket` &mdash; A string representing the bucket. When specified, it is automatically appended to the object path, and thus, it should not be manually included in the target path by the user. 

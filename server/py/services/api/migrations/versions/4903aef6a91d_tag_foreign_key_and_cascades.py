...
def upgrade():
    ...
    op.drop_constraint("_feature_sets_tags_obj_name_fk", "feature_sets_tags", type_="foreignkey")
    op.drop_constraint("_feature_vectors_tags_obj_name_fk", "feature_vectors_tags", type_="foreignkey")
    op.drop_constraint("_functions_tags_obj_name_fk", "functions_tags", type_="foreignkey")

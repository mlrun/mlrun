...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("artifact", None, "/path/to/artifact", f"{STORE_PREFIX}@dummy-tree"),
        ("artifact", "latest", "/path/to/artifact", f"{STORE_PREFIX}@dummy-tree"),
        ("dataset", "v1", "/path/to/artifact", f"{STORE_PREFIX}:v1@dummy-tree"),
        ("dataset", None, "/path/to/artifact", f"{STORE_PREFIX}@dummy-tree"),
        ("dataset", "latest", "/path/to/artifact", f"{STORE_PREFIX}@dummy-tree"),
        ("model", "v1", "/path/to/artifact", f"{STORE_PREFIX}:v1@dummy-tree"),
        ("model", None, "/path/to/artifact", f"{STORE_PREFIX}@dummy-tree"),
        ("model", "latest", "/path/to/artifact", f"{STORE_PREFIX}@dummy-tree"),

...
To review the mock server api, see [here](../api/mlrun.runtimes/index.rst) (TODO: Kate) #mlrun.runtimes.ServingRuntime.to_mock_server).
...
See [`.add_model()`](../api/mlrun.runtimes/index.rst) (TODO: Kate) #mlrun.runtimes.ServingRuntime.add_model) docstring for help and parameters.

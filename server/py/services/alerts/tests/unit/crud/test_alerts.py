...
class TestAlerts(TestAlertsBase):
    ...
    @unittest.mock.patch.object(
        framework.utils.singletons.db.SQLDB, "update_alert_activation_on_reset"
    )
    @unittest.mock.patch.object(
    ...
    async def test_process_event_no_cache(
        self,
        mocked_update_alert_activation_on_reset,
        mocked_store_alert_activation,
        db: sqlalchemy.orm.Session,
        k8s_secrets_mock: K8sSecretsMock,
    ):
        mocked_update_alert_activation_on_reset.return_value = None

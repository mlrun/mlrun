...
class Member(project_leader.Member):
    ...
    def create_project(
        ...
        ) = services.api.utils.singletons.project_member.get_project_member().create_project(
    ...
    def delete_project(
        ...
        return services.api.utils.singletons.project_member.get_project_member().delete_project(

...
# ``mlrun.common.schemas.client_spec`` import path. Mirrors the full namespace of the underlying
...
if _USE_V2:
    from ._v2 import client_spec as _face_mod
else:
    from ._v1 import client_spec as _face_mod

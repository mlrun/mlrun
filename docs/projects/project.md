...
MLRun project is a container for all your work on a particular ML or gen AI application. Projects host [functions](../runtimes/functions.md), [workflows](../concepts/workflow-overview.md),

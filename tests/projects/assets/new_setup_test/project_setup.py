...
def setup(project: mlrun.projects.MlrunProject):
    ...
    prep_func = project.set_function("prep_data.py", "prep-data", kind="job", image="mlrun/mlrun")
    prep_func.set_label("tst1", project.get_param("p2"))

    srv_func = project.set_function("serving.py", "serving", kind="serving", image="mlrun/mlrun")

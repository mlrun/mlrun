...
The files can reside on S3, NFS, Azure blob storage or on Iguazio platform. Please note that for working with S3/Azure, s3fs/adlfs libraries must be installed.<br>

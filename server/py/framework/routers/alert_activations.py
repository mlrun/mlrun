...
async def list_alert_activations(
    ...
    severity: list[mlrun.common.schemas.alert.AlertSeverity | str] | None = Query(
        [], alias="severity"
    ),
    entity_kind: mlrun.common.schemas.alert.EventEntityKind | str | None = Query(
        None, alias="entity-kind"
    ),
    event_kind: mlrun.common.schemas.alert.EventKind | str | None = Query(

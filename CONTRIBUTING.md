...
- **Local enforcement**: Pre-commit hooks are installed automatically when you run `make install-dev-requirements`, which installs dev requirements and runs `pre-commit install`

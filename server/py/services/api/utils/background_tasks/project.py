...
class ProjectBackgroundTasksHandler(metaclass=mlrun.utils.singleton.Singleton):
    def create_background_task(
        ...
        **kwargs,
        ...
        services.api.utils.singletons.db.get_db().store_background_task(
            db_session,
            name,
            project,
    ...
    def get_background_task(
        ...
        return services.api.utils.singletons.db.get_db().get_background_task(
            db_session,
            name,
            project,
            services.api.utils.background_tasks.common.background_task_exceeded_timeout,
        )
    ...
    def list_background_tasks(
        ...
        return services.api.utils.singletons.db.get_db().list_background_tasks(
            db_session,
            project,
            services.api.utils.background_tasks.common.background_task_exceeded_timeout,
            states=states,

...
# ``mlrun.common.schemas.alert`` import path. Mirrors the full namespace of the underlying
...
from ._shared import alert as _shared_mod

if _USE_V2:
    from ._v2 import alert as _face_mod
else:
    from ._v1 import alert as _face_mod

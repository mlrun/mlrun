...
import server.api.utils.projects.remotes.follower
...
def test_projects_sync_follower_project_adoption(
    ...
    projects_leader: server.api.utils.projects.leader.Member,
    nop_follower: server.api.utils.projects.remotes.follower.Member,
    second_nop_follower: server.api.utils.projects.remotes.follower.Member,

...
- Resolve auto tags: If you specify ```image="mlrun/mlrun"``` the API fills in the tag by the client version, e.g. changes it to `mlrun/mlrun:0.9.2`. So, if the client gets upgraded you'll automatically get a new API image. 

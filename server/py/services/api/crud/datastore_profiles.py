...
class DatastoreProfiles(
    ...
    def store_datastore_profile(
        ...
        server.py.services.api.utils.singletons.db.get_db().store_datastore_profile(
    ...
    def list_datastore_profiles(
        ...
        project = project or mlrun.mlconf.default_project
        return (
            server.py.services.api.utils.singletons.db.get_db().list_datastore_profiles(
                session, project
            )
        )
    ...
    def delete_datastore_profile(
        ...
        server.py.services.api.utils.singletons.db.get_db().delete_datastore_profile(
    ...
    def get_datastore_profile(
        ...
        project = project or mlrun.mlconf.default_project
        return (
            server.py.services.api.utils.singletons.db.get_db().get_datastore_profile(
                session, profile_name, project
            )
        )

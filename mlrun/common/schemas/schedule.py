...
# ``mlrun.common.schemas.schedule`` import path. Mirrors the full namespace of the underlying
...
from ._shared import schedule as _shared_mod

if _USE_V2:
    from ._v2 import schedule as _face_mod
else:
    from ._v1 import schedule as _face_mod

...
from server.py.services.api.db.base import DBError
from server.py.services.api.db.sqldb.db import SQLDB

# This class is a proxy for the real implementation that sits under server.py.services.api.db.sqldb
...
class SQLRunDB(RunDBInterface):
    ...
    def store_log(self, uid, project="", body=b"", append=False):
        return self._transform_db_error(
            server.py.services.api.crud.Logs().store_log,
            body,
            project,
            uid,
            append,
    ...
    def update_run(self, updates: dict, uid, project="", iter=0):
        return self._transform_db_error(
            server.py.services.api.crud.Runs().update_run,
            self.session,
            project,
            uid,
            iter,
    ...
    def read_run(self, uid, project=None, iter=None):
        return self._transform_db_error(
            server.py.services.api.crud.Runs().get_run,
            self.session,
            uid,
            iter,
            project,
    ...
    def list_runs(
        ...
        return self._transform_db_error(
            ...
            server.py.services.api.crud.Runs().list_runs,
            name=name,
            uid=uid,
            project=project,
            labels=labels,
    ...
    async def del_run(self, uid, project=None, iter=None):
        return await self._transform_db_error(
            server.py.services.api.crud.Runs().delete_run,
            self.session,
            uid,
            iter,
            project,
    ...
    async def del_runs(
        ...
        return await self._transform_db_error(
            server.py.services.api.crud.Runs().delete_runs,
            self.session,
            name,
            project,
            labels,
    ...
    def store_artifact(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.Artifacts().store_artifact,
            self.session,
            key,
            artifact,
            uid,
    ...
    def read_artifact(self, key, tag="", iter=None, project="", tree=None, uid=None):
        return self._transform_db_error(
            server.py.services.api.crud.Artifacts().get_artifact,
            self.session,
            key,
            tag=tag,
            iter=iter,
    ...
    def list_artifacts(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.Artifacts().list_artifacts,
            self.session,
            project,
            name,
            tag,
    ...
    def del_artifact(self, key, tag="", project="", tree=None, uid=None):
        return self._transform_db_error(
            server.py.services.api.crud.Artifacts().delete_artifact,
            self.session,
            key,
            tag,
            project,
    ...
    def del_artifacts(self, name="", project="", tag="", labels=None):
        return self._transform_db_error(
            server.py.services.api.crud.Artifacts().delete_artifacts,
            self.session,
            project,
            name,
            tag,
    ...
    def store_function(self, function, name, project="", tag="", versioned=False):
        return self._transform_db_error(
            server.py.services.api.crud.Functions().store_function,
            self.session,
            function,
            name,
            project,
    ...
    def get_function(self, name, project="", tag="", hash_key=""):
        return self._transform_db_error(
            server.py.services.api.crud.Functions().get_function,
            self.session,
            name,
            project,
            tag,
    ...
    def delete_function(self, name: str, project: str = ""):
        return self._transform_db_error(
            server.py.services.api.crud.Functions().delete_function,
            self.session,
            project,
            name,
        )
    ...
    def list_functions(self, name=None, project=None, tag=None, labels=None):
        return self._transform_db_error(
            server.py.services.api.crud.Functions().list_functions,
    ...
    def tag_objects(
        ...
        if replace:
            return self._transform_db_error(
                server.py.services.api.crud.Tags().overwrite_object_tags_with_tag,
                self.session,
                project,
                tag_name,
                tag_objects,
        ...
        return self._transform_db_error(
            server.py.services.api.crud.Tags().append_tag_to_objects,
            self.session,
            project,
            tag_name,
            tag_objects,
    ...
    def delete_objects_tag(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.Tags().delete_tag_from_objects,
            self.session,
            project,
            tag_name,
            tag_objects,
    ...
    def store_project(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.Projects().store_project,
            self.session,
            name=name,
            project=project,
        )
    ...
    def patch_project(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.Projects().patch_project,
            self.session,
            name=name,
            project=project,
    ...
    def create_project(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.Projects().create_project,
            self.session,
            project=project,
        )
    ...
    def delete_project(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.Projects().delete_project,
            self.session,
            name=name,
    ...
    def get_project(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.Projects().get_project,
            self.session,
            name=name,
        )
    ...
    def list_projects(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.Projects().list_projects,
            self.session,
            owner=owner,
            format_=format_,
            labels=labels,
    ...
    def create_feature_set(self, feature_set, project="", versioned=True):
        return self._transform_db_error(
            server.py.services.api.crud.FeatureStore().create_feature_set,
            self.session,
            project,
            feature_set,
            versioned,
    ...
    def get_feature_set(
        ...
        feature_set = self._transform_db_error(
            server.py.services.api.crud.FeatureStore().get_feature_set,
            self.session,
            project,
            name,
            tag,
    ...
    def list_features(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.FeatureStore().list_features,
            self.session,
            project,
            name,
            tag,
    ...
    def list_entities(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.FeatureStore().list_entities,
            self.session,
            project,
            name,
            tag,
    ...
    def list_feature_sets(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.FeatureStore().list_feature_sets,
            self.session,
            project,
            name,
            tag,
    ...
    def store_feature_set(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.FeatureStore().store_feature_set,
            self.session,
            project,
            name,
            feature_set,
    ...
    def patch_feature_set(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.FeatureStore().patch_feature_set,
            self.session,
            project,
            name,
            feature_set,
    ...
    def delete_feature_set(self, name, project="", tag=None, uid=None):
        return self._transform_db_error(
            server.py.services.api.crud.FeatureStore().delete_feature_set,
            self.session,
            project,
            name,
            tag,
    ...
    def create_feature_vector(self, feature_vector, project="", versioned=True):
        return self._transform_db_error(
            server.py.services.api.crud.FeatureStore().create_feature_vector,
            self.session,
            project,
            feature_vector,
            versioned,
    ...
    def get_feature_vector(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.FeatureStore().get_feature_vector,
            self.session,
            project,
            name,
            tag,
    ...
    def list_feature_vectors(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.FeatureStore().list_feature_vectors,
            self.session,
            project,
            name,
            tag,
    ...
    def store_feature_vector(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.FeatureStore().store_feature_vector,
            self.session,
            project,
            name,
            feature_vector,
    ...
    def patch_feature_vector(
        ...
        return self._transform_db_error(
            server.py.services.api.crud.FeatureStore().patch_feature_vector,
            self.session,
            project,
            name,
    ...
    def delete_feature_vector(self, name, project="", tag=None, uid=None):
        return self._transform_db_error(
            server.py.services.api.crud.FeatureStore().delete_feature_vector,
            self.session,
            project,
            name,
            tag,
    ...
    def store_run_notifications(
        ...
        return self._transform_db_error(
            server.py.services.api.db.session.run_function_with_new_db_session,
            server.py.services.api.crud.Notifications().store_run_notifications,
    ...
    def function_status(self, project, name, kind, selector):
        ...
        """
        return self._transform_db_error(
            server.py.services.api.crud.Functions().get_function_status,
            kind,
            selector,
        )
    ...
    def start_function(
        ...
        """
        return self._transform_db_error(
            server.py.services.api.crud.Functions().start_function,
            function,
        )
    ...
    def list_hub_sources(
        ...
        return self._transform_db_error(
            server.py.services.api.db.session.run_function_with_new_db_session,
            server.py.services.api.crud.Hub().list_hub_sources,
            item_name,
            tag,
            version,
        )
    ...
    def get_datastore_profile(
        ...
        return self._transform_db_error(
            server.py.services.api.db.session.run_function_with_new_db_session,
            server.py.services.api.crud.DatastoreProfiles().get_datastore_profile,
            name,
            project,
        )

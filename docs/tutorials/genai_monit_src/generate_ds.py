import mlrun
from mlrun import MLClientCtx, DataItem
import openai
from datasets import Dataset
from huggingface_hub import login, DatasetCard, create_repo
...
def generate_llm_right_answer(client, question):
    ...
    In case the question is not banking related, please reject it with "As a banking agent, I am not allowed to talk on this subject. Is there anything else I can help with?"
    The question:
    {question}
    """

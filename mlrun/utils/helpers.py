...
class Workflow:
    ...
    def get_workflow_steps(workflow_id: str, project: str) -> list:
        ...
        step_methods = {
            pipeline_run_type.PipelineRunType.run: _add_run_step,
            pipeline_run_type.PipelineRunType.build: _add_deploy_function_step,
            pipeline_run_type.PipelineRunType.deploy: _add_deploy_function_step,
        }

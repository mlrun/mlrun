...
async def trigger_migrations(
    ...
    if not background_task:
        ...
        background_task = background_tasks_handlers.InternalBackgroundTasksHandler().get_background_task(
            task_name
        )
...
def _get_or_create_migration_background_task(
    ...
    (
        task,
        task_name,
    ) = background_tasks_handlers.InternalBackgroundTasksHandler().create_background_task(
        background_tasks_handlers.BackgroundTaskKinds.db_migrations,
        None,
        _perform_migration,
    )

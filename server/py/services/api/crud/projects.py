        ...
        for project_data in projects_output.projects:
            ...
            project_summaries.append(
                mlrun.common.schemas.ProjectSummary(
                    ...
                    running_model_monitoring_functions=project_to_running_mm_functions.get(project_name, 0),
                    failed_model_monitoring_functions=project_to_failed_mm_functions_count.get(project_name,0),
                    real_time_model_endpoint_count = project_to_real_time_mep_count.get(project_name, 0),
                    batch_model_endpoint_count = project_to_batch_mep_count.get(project_name, 0),
                )
            )

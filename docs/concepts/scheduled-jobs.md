...
1. The [project_setup](https://docs.mlrun.org/en/stable/projects/project-setup.html) that may affect the project configuration (if it exists).
2. Syncing function files.

...
def run_function(
    ...
    handler: str | typing.Callable | None = None,
    name: str = "",
...
) -> mlrun.model.RunObject | mlrun_pipelines.models.PipelineNodeWrapper:
...
) -> BuildStatus | mlrun_pipelines.models.PipelineNodeWrapper:
...
def deploy_function(
    ...
    project_object=None,
    mock: bool | None = None,
) -> DeployStatus | mlrun_pipelines.models.PipelineNodeWrapper:

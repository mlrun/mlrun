...
# ``mlrun.common.schemas.api_gateway`` import path. Mirrors the full namespace of the underlying
...
from ._shared import api_gateway as _shared_mod

if _USE_V2:
    from ._v2 import api_gateway as _face_mod
else:
    from ._v1 import api_gateway as _face_mod

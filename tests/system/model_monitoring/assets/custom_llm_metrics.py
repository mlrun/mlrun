...
PROMPT_CONFIG = {
    ...
    "examples": """
        ...
        Answer: "The capital of France is Paris, which is not only the country's largest city but also its cultural and political ceter, hosting major institutions like the President's residence, the Elysée Palace."

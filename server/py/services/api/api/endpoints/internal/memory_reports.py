...
import server.py.services.api.utils.memory_reports
...
def get_most_common_objects_report():
    report = server.py.services.api.utils.memory_reports.MemoryUsageReport().create_most_common_objects_report()
...
def get_memory_usage_report(
    ...
    report = server.py.services.api.utils.memory_reports.MemoryUsageReport().create_memory_usage_report(

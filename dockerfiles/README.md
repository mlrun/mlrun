...
For example, running `MLRUN_VERSION=1.0.2 make docker-images` will generate the following images:
  * `mlrun/mlrun-api:1.0.2`
  * `mlrun/mlrun:1.0.2`
  * `mlrun/jupyter:1.0.2`
  * `mlrun/ml-base:1.0.2`
  * `mlrun/ml-models:1.0.2`
  * `mlrun/ml-models-gpu:1.0.2` 

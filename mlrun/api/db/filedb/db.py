...
class FileDB(DBInterface):
    ...
    def list_projects(
        self, session, owner: str = None, format_: schemas.Format = schemas.Format.full, labels: List[str] = None,
    ) -> schemas.ProjectsOutput:
        return self._transform_run_db_error(self.db.list_projects, owner, format_, labels)

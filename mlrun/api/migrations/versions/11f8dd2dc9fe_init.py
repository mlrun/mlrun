...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("key", sa.String(255, collation='utf8_bin'), nullable=True),
        sa.Column("project", sa.String(255, collation='utf8_bin'), nullable=True),
        sa.Column("uid", sa.String(255, collation='utf8_bin'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("name", sa.String(255, collation='utf8_bin'), nullable=True),
        sa.Column("description", sa.String(255, collation='utf8_bin'), nullable=True),
        sa.Column("owner", sa.String(255, collation='utf8_bin'), nullable=True),
        sa.Column("source", sa.String(255, collation='utf8_bin'), nullable=True),
        sa.Column("spec", sa.BLOB(), nullable=True),
        sa.Column("created", sa.TIMESTAMP(), nullable=True),
        sa.Column("state", sa.String(255, collation='utf8_bin'), nullable=True),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        "schedules_v2",
        sa.Column("project", sa.String(255, collation='utf8_bin'), nullable=False),
        sa.Column("name", sa.String(255, collation='utf8_bin'), nullable=False),
        sa.Column("kind", sa.String(255, collation='utf8_bin'), nullable=True),
        sa.Column("desired_state", sa.String(255, collation='utf8_bin'), nullable=True),
        sa.Column("state", sa.String(255, collation='utf8_bin'), nullable=True),
        sa.Column("creation_time", sa.TIMESTAMP(), nullable=True),
        sa.Column("cron_trigger_str", sa.String(255, collation='utf8_bin'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(255, collation='utf8_bin'), nullable=True),
        sa.Column("obj_id", sa.Integer(), nullable=True),
        sa.Column("obj_name", sa.String(255, collation='utf8_bin'), nullable=True),

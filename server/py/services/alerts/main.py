...
class Service(framework.service.Service):
    ...
    async def list_alert_activations(
        ...
        until: str | None,
        entity: str | None,
        severity: list[mlrun.common.schemas.alert.AlertSeverity | str] | None,
        entity_kind: mlrun.common.schemas.alert.EventEntityKind | str | None,
        event_kind: mlrun.common.schemas.alert.EventKind | str | None,
        page: int,
        page_size: int,
        page_token: str,
        auth_info: mlrun.common.schemas.AuthInfo,

...
def initialize_project_member():
    ...
    if mlconf.httpdb.projects.leader in ["mlrun", "nop-self-leader"]:
        project_member = framework.utils.projects.leader.Member()
        project_member.initialize()
    else:
        project_member = framework.utils.projects.follower.Member()
        project_member.initialize()


def get_project_member() -> framework.utils.projects.member.Member:
    global project_member

...
from server.py.services.api.api.utils import get_allowed_path_prefixes_list
...
def get_frontend_spec(
    ...
    return mlrun.common.schemas.FrontendSpec(
        ...
        function_deployment_mlrun_requirement=server.py.services.api.utils.builder.resolve_mlrun_install_command_version(),
...
def _resolve_feature_flags() -> mlrun.common.schemas.FeatureFlags:
    ...
    if mlrun.mlconf.get_parsed_igz_version() and semver.VersionInfo.parse(
        server.py.services.api.utils.runtimes.nuclio.resolve_nuclio_version()

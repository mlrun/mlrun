...
MLRun, and the associated `storey` package, have a built-in library of [transformation functions](../serving/basic-steps.md) that can be 
...
See the [built-in steps](../serving/basic-steps.md).

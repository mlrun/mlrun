...
class TestProject(TestMLRunSystem):
    ...
    def test_run_function_uses_user_defined_artifact_path_over_project_artifact_path(self):
        func_name = "my-func"
        self.project.set_function(
            str(self.assets_path / "handler.py"),
            func_name,
        ...
        run = self.project.run_function(func_name, artifact_path="/User/user_artifact_path")

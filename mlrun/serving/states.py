...
class BaseStep(ModelObj):
    ...
    def to(
        self,
        class_name: str | StepToDict = None,
        name: str | None = None,
    ...
    def cycle_to(self, step_names: str | list[str]):
    ...
    def set_flow(
        self,
        steps: list[str | StepToDict | dict[str, Any]],
        force: bool = False,
    ):
        """
    ...
    def _edit_proxy_model_data(
        ...
        artifact: ModelArtifact | LLMPromptArtifact | str,
    ):
...
class Model(storey.ParallelExecutionRunnable, ModelObj):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.shared_proxy_mapping: dict[
            str : str | ModelArtifact | LLMPromptArtifact
        ] = shared_proxy_mapping
    ...
    ) -> ModelArtifact | LLMPromptArtifact | None:
...
class LLModel(Model):
    ...
    **Simplified Example**:
    ...
    def predict(
        self,
        body: Any,
        messages: list[dict] | list[list[dict]] | None = None,
...
class ModelRunnerStep(MonitoredStep):
    ...
    def __init__(
        ...
        *args,
        name: str | None = None,
        model_runner_selector: str | ModelRunnerSelector | None = None,
    ...
    def add_shared_model_proxy(
        self,
        endpoint_name: str,
        model_artifact: str | ModelArtifact | LLMPromptArtifact,
    ...
    def add_model(
        ...
        execution_mechanism: str | ParallelExecutionMechanisms,
        model_artifact: str | ModelArtifact | LLMPromptArtifact | None = None,
        labels: list[str] | dict[str, str] | None = None,
        model_endpoint_creation_strategy: schemas.ModelEndpointCreationStrategy
        | None = schemas.ModelEndpointCreationStrategy.INPLACE,
    ...
    def _convert_model_selector_to_model_runner_selector(
        ...
        class Adapter(ModelRunnerSelector):
            ...
            def select_models(self, event, available_models) -> list[str] | list[Model]:
...
class RootFlowStep(FlowStep):
    ...
    def add_shared_model(
        ...
        model_class: str | Model,
        execution_mechanism: str | ParallelExecutionMechanisms,
        model_artifact: str | ModelArtifact,
        inputs: list[str] | None = None,
        outputs: list[str] | None = None,
        input_path: str | None = None,
        result_path: str | None = None,

...
class Client(
    ...
    def wait_for_run_completion(
        ...
        while status not in mlrun_pipelines.common.models.RunStatuses.stable_statuses() or status not in mlrun_pipelines.common.models.RunStatuses.terminating_statuses():
            try:

...
class PipelineServiceApi:
    ...
    def create_pipeline_version_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `body` when calling `create_pipeline_version`"
            )  # noqa: E501
    ...
    def delete_pipeline_version_with_http_info(self, version_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.delete_pipeline_version_with_http_info(
        ...     version_id, async_req=True
        ... )
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and (
            "version_id" not in local_var_params  # noqa: E501
            or local_var_params["version_id"] is None
        ):  # noqa: E501
            raise ApiValueError(
    ...
    def get_pipeline_version_template_with_http_info(self, version_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_pipeline_version_template_with_http_info(
        ...     version_id, async_req=True
        ... )
        >>> result = thread.get()
    ...
    def list_pipeline_versions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        query_params = []
        if (
            "resource_key_type" in local_var_params
            and local_var_params["resource_key_type"] is not None
        ):  # noqa: E501
            query_params.append(
                ("resource_key.type", local_var_params["resource_key_type"])
            )  # noqa: E501
        if (
            "resource_key_id" in local_var_params
            and local_var_params["resource_key_id"] is not None
        ):  # noqa: E501
            query_params.append(
                ("resource_key.id", local_var_params["resource_key_id"])
            )  # noqa: E501
        if (
    ...
    def update_pipeline_default_version(self, pipeline_id, version_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.update_pipeline_default_version(
        ...     pipeline_id, version_id, async_req=True
        ... )
        >>> result = thread.get()
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.update_pipeline_default_version_with_http_info(
            pipeline_id, version_id, **kwargs
        )  # noqa: E501

    def update_pipeline_default_version_with_http_info(
        self, pipeline_id, version_id, **kwargs
    ):  # noqa: E501
        """Update the default pipeline version of a specific pipeline.  # noqa: E501
        ...
        >>> thread = api.update_pipeline_default_version_with_http_info(
        ...     pipeline_id, version_id, async_req=True
        ... )
        >>> result = thread.get()
        ...
        all_params = ["pipeline_id", "version_id"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        if self.api_client.client_side_validation and (
            "pipeline_id" not in local_var_params  # noqa: E501
            or local_var_params["pipeline_id"] is None
        ):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `pipeline_id` when calling `update_pipeline_default_version`"
            )  # noqa: E501
        # verify the required parameter 'version_id' is set
        if self.api_client.client_side_validation and (
            "version_id" not in local_var_params  # noqa: E501
            ...
            raise ApiValueError(
                "Missing the required parameter `version_id` when calling `update_pipeline_default_version`"
            )  # noqa: E501

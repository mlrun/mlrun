...
import mlrun.config
import mlrun.errors
import server.py.services.api.utils.projects.leader
...
async def projects_leader() -> (
    typing.Generator[server.py.services.api.utils.projects.leader.Member, None, None]
):
    ...
    projects_leader = (
        server.py.services.api.utils.singletons.project_member.get_project_member()
    )
...
async def nop_follower(
    projects_leader: server.py.services.api.utils.projects.leader.Member,
...
def test_projects_sync_follower_project_adoption(
    ...
    projects_leader: server.py.services.api.utils.projects.leader.Member,
    nop_follower: server.py.services.api.utils.projects.remotes.follower.Member,
    second_nop_follower: server.py.services.api.utils.projects.remotes.follower.Member,
    leader_follower: server.py.services.api.utils.projects.remotes.follower.Member,
):

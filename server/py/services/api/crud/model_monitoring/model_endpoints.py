...
class ModelEndpoints:
    ...
    def create_model_endpoint(
        ...
        if model_endpoint.spec.model_uri:
            ...
            run_db = server.py.services.api.api.utils.get_run_db_instance(db_session)
        ...
        model_endpoint_store = get_model_endpoint_store(
            project=model_endpoint.metadata.project,
            secret_provider=server.py.services.api.crud.secrets.get_project_secret_provider(
                project=model_endpoint.metadata.project
            ),
        )
    ...
    def _get_features(
        ...
        project: str,
        run_db: server.py.services.api.rundb.sqldb.SQLRunDB,
    ...
    def create_monitoring_feature_set(
        ...
        parquet_path = (
            server.py.services.api.crud.model_monitoring.helpers.get_monitoring_parquet_path(
    ...
    def _convert_into_model_endpoint_object(
        ...
        if feature_analysis and endpoint_obj.spec.feature_names:
            endpoint_features = server.py.services.api.crud.model_monitoring.deployment.get_endpoint_features(
            ...
            if endpoint_features:
                ...
                drift_measures = server.py.services.api.crud.model_monitoring.helpers.json_loads_if_not_none(
                    endpoint.get(

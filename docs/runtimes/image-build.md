...
If you are using a `zip` source file, verify that you installed `unzip` on your running image. See also [MLRun runtime images](../runtimes/images.md#mlrun-runtime-images).

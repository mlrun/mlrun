...
from mlrun.model_monitoring.db.tsdb.timescaledb.utils.timescaledb_pre_aggregate_manager import (
...
class TimescaleDBResultsQueries:
    """
    Mixin class containing results and drift-related query methods for TimescaleDB.
    ...
    def get_drift_status(
        ...
        # Set internal parameters for backward compatibility
        ...
        # Create pre-aggregate manager for this operation
        pre_agg_manager = TimescaleDBPreAggregateManager(
            self._pre_aggregate_handler, self._connection
        )
        ...
        return pre_agg_manager.execute_with_fallback(
            build_pre_agg_query,
            build_raw_query,
            interval=interval,
            agg_funcs=[agg_func],
    ...
    def count_results_by_status(
        ...
        filter_query = TimescaleDBQueryBuilder.combine_filters(filter_conditions, "AND")

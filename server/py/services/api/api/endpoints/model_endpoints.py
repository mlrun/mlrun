...
async def create_model_endpoint(
    ...
    return await run_in_threadpool(
        server.py.services.api.crud.ModelEndpoints().create_model_endpoint,
...
async def patch_model_endpoint(
    ...
    return await run_in_threadpool(
        server.py.services.api.crud.ModelEndpoints().patch_model_endpoint,
        project=project,
...
async def delete_model_endpoint(
    ...
    await run_in_threadpool(
        server.py.services.api.crud.ModelEndpoints().delete_model_endpoint,
        project=project,
        endpoint_id=endpoint_id,
    )
...
async def list_model_endpoints(
    ...
    endpoints = await run_in_threadpool(
        server.py.services.api.crud.ModelEndpoints().list_model_endpoints,
        auth_info=auth_info,
        project=project,
        model=model,
        function=function,
...
async def get_model_endpoint(
    ...
    return await run_in_threadpool(
        server.py.services.api.crud.ModelEndpoints().get_model_endpoint,
        auth_info=auth_info,
        project=project,
        endpoint_id=endpoint_id,
        metrics=metrics,
